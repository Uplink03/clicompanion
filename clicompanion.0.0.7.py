...
class Companion:
    ...
    def response_to_dialog(self, text, dialog, response):
    ...
    def add_command(self, widget, data=None):
        ...
        entry3 = gtk.Entry()
        #allow the user to press enter to do ok
        entry1.connect("activate", self.response_to_dialog, dialog, gtk.RESPONSE_OK)
    ...
    def __init__(self):
        ...
        def button_box(self, spacing, layout):
            ...
            buttonCancel.connect("clicked", self.quit_event)
            #Help Button
